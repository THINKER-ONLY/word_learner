...
- **AI学习助手**: 集成DeepSeek AI，提供智能学习辅助功能
...
### 🤖 AI学习助手
- **单词解释**: 获取详细的单词含义、用法和使用场景
- **记忆技巧**: 提供个性化的单词记忆方法和技巧
- **例句生成**: 生成实用的例句帮助理解单词用法
- **单词测试**: 创建个性化的单词测试题目
- **智能对话**: 与AI进行关于英语学习的自然对话
- **上下文感知**: AI会基于当前学习的单词提供相关建议

### ⚙️ 个性化设置
- **显示间隔**: 自定义自动切换单词的时间间隔
- **显示模式**: 选择随机显示或顺序显示
- **中文显示**: 控制是否显示中文翻译
- **AI配置**: 设置DeepSeek API密钥以启用AI功能
...
```json
{
  ...
  "deepseek_api_key": ""       // DeepSeek API密钥（用于AI功能）
}
```
...
要使用AI学习助手功能，请参考 [DeepSeek AI 设置指南](DEEPSEEK_SETUP.md)，了解如何：
- 获取DeepSeek API密钥
- 配置AI服务
- 使用AI功能
- 故障排除
